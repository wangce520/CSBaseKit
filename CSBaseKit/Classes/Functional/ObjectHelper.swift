...
public class ObjectHelper {
    ...
    // 对比两个对象地址是否相等
    public static func equatableAnyObject(_ object1 : AnyObject, _ object2 : AnyObject) -> Bool {
    ...
    // 获取对象地址
    public static func getAnyObjectMemoryAddress(_ object : AnyObject) -> String {
